    ...
    def to(self, *args, **kwargs):
        ...
        if self.whitener is not None:
            if hasattr(self.whitener, 'mean') and self.whitener.mean is not None:
                self.whitener.mean = self.whitener.mean.to(*args, **kwargs)
                self.whitener.whitening_matrix = self.whitener.whitening_matrix.to(*args, **kwargs)
                self.whitener.dewhitening_matrix = self.whitener.dewhitening_matrix.to(*args, **kwargs)
        return self
...
def eval_saes(
    ...
    for ae_path in ae_paths:
        ...
        if os.path.exists(pca_path):
            ...
            # Import PCAWhitener from your trainer file
            from dictionary_learning.dictionary_learning.trainers.standard import PCAWhitener
